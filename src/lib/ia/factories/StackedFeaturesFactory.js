/** 
 * Factory for creating stacked features time series charts.
 *
 * @author J Clare
 * @class ia.StackedFeaturesFactory
 ...
 */
ia.StackedFeaturesFactory = function(config, report, componentGroup)
{
	ia.StackedFeaturesFactory.baseConstructor.call(this, config, report, componentGroup);
	...
	this.build = function(callbackFunction)
	{
		...
		// Layer.
		layer = new ia.StackedFeaturesLayer();
...
ia.extend(ia.ChartFactory, ia.StackedFeaturesFactory);